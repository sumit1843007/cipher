      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'User logged in successfully');
...
var signUp = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(name, email, password, confirmPassword) {
    var res;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type, " User update  successfully"));
          }
          _context.next = 14;
          break;
        case 10:
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51NBvFhSDNnF4fdWajXUsT3wq0LZZTfA4QdptxusHwGesKnUfXjlIvOwSSgUBUIXabiJNa1lO1wmX5hez7F3lwYtY00xihjYVUN');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("http://localhost:8000/api/bookings/check-out/".concat(tourId));
        case 3:
...
var updateSting = document.querySelector(".form-user-data");
var updatePassword = document.querySelector("#savePassword");
var bookBtn = document.querySelector('#book-tour');
var signUpForm = document.querySelector('#form1');
console.log(bookBtn);
if (loginForm) {
  console.log({
    email: email,
...
if (updateSting) {
  updateSting.addEventListener('submit', /*#__PURE__*/function () {
...
if (updatePassword) {
  updatePassword.addEventListener('click', /*#__PURE__*/function () {
